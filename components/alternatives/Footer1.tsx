...
// ── Guestbook entries (would come from DB in production) ─────
...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      {/* ── SPRAY PAINT BACKGROUND ── completely different from other sections ── */}
      <div className="absolute inset-0 pointer-events-none">

        {/* Large spray blobs — warm orange/red palette, unlike the green/blue of projects */}
        <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(255,160,0,0.05) 0%, transparent 65%)",
          filter: "blur(100px)",
        }} />
        <div style={{
          position: "absolute", bottom: "-5%", left: "30%",
          width: "500px", height: "400px", borderRadius: "50%",
          background: "radial-gradient(circle, rgba(200,0,255,0.05) 0%, transparent 65%)",
          filter: "blur(90px)",
        }} />
        <div style={{
          position: "absolute", bottom: "10%", left: "-5%",
          width: "350px", height: "350px", borderRadius: "50%",
          background: "radial-gradient(circle, rgba(255,220,0,0.04) 0%, transparent 65%)",
          filter: "blur(70px)",
        }} />

        {/* Diagonal spray streaks */}
        {[...Array(6)].map((_, i) => (
          <div key={i} style={{
            position: "absolute",
            top: `${10 + i * 18}%`,
            ...
            width: `${200 + i * 30}px`,
            height: "1px",
            background: `linear-gradient(to right, transparent, rgba(255,${80 + i * 20},0,0.06), transparent)`,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-12">
        ...
        <div ref={graffitiRef} className="relative mb-20 overflow-visible">

          {/* Spray paint drips behind text */}
          {/* <div className="absolute -top-4 left-[8%] pointer-events-none select-none">
            {[...Array(5)].map((_, i) => (
              <div key={i} style={{
                display: "inline-block",
                width: `${3 + i}px`,
                height: `${30 + i * 15}px`,
                marginRight: `${8 + i * 3}px`,
                background: `rgba(255,${60 + i * 20},0,${0.15 + i * 0.04})`,
          ...
          {/* Main graffiti text */}
          <h2
            className="font-docallisme leading-[0.82] select-none"
            style={{
          ...
          >
            Let&lsquo;s<br />
            <span style={{ marginLeft: "clamp(40px, 8vw, 120px)" }}>Build.</span>
          </h2>

          {/* Subtitle */}
          <p className="font-comforter text-white/30 italic mt-4 ml-1"
            style={{ fontSize: "clamp(16px, 2vw, 24px)" }}>
            — open to work, collabs & conversations
          </p>

          {/* Decorative tag — like a graffiti artist tag */}
          <div
            className="absolute bottom-0 right-0 font-comforter italic text-white/10 pointer-events-none select-none"
            style={{ fontSize: "clamp(40px, 6vw, 90px)", lineHeight: 1 }}
          >
            dixen&lsquo;26
          </div>
        </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 mt-0.5"
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke="rgba(255,100,0,0.8)" strokeWidth="1.8" strokeLinecap="round">
            ...
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 mt-0.5"
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke="rgba(255,160,0,0.8)" strokeWidth="1.8" strokeLinecap="round">
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl w-fit mt-2"
              ...
              <span className="text-green-400/80 text-xs font-medium tracking-wide">
                Available for work — Mar 2026
              </span>
            </div>
          </div>

          {/* ── COL 2 & 3: Platform links — 2 column grid ── */}
        ...
        <div ref={formRef} className="mb-16">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
              ...
              <h3 className="font-docallisme text-white text-4xl md:text-5xl leading-none">
                Leave your mark.
              </h3>
            ...
            <div className="flex flex-col items-center gap-2 shrink-0">
              ...
              <div className="relative" ref={particlesRef}>
                ...
                >
                  <span style={{ fontSize: "28px", filter: liked ? "none" : "grayscale(1) opacity(0.4)", transition: "filter 0.3s" }}>
                    ❤️
                  </span>
                  <span
                    className="font-docallisme text-2xl leading-none"
                    style={{ color: liked ? "#ff5050" : "rgba(255,255,255,0.3)" }}
                  >
                    {likeCount}
                  </span>
              ...
              {submitted ? (
                ...
                <>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-white/30 text-[10px] tracking-[0.25em] uppercase">
                      your name / handle
                    </label>
                    <input
                      type="text"
              ...
              {messages.map((m, i) => (
                <div key={i}
                  ...
                  style={{
                    ...
                    animation: i === 0 && messages.length > existingMessages.length
                      ? "slideIn 0.4s ease-out" : "none",
                  }}
                >
                  {/* Avatar initial */}
                  <div
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8"
          ...
          <div className="flex items-center gap-6 text-white/15 text-">
            <span>© 2026</span>
            <span>·</span>
