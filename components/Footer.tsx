...
function StatCounter({
  ...
  return (
    <div ref={ref} className="flex flex-col items-center gap-1.5">
      ...
      <span className="text-white/25 text-[9px] tracking-[0.3em] uppercase text-center">
        {label}
      </span>
    </div>
  );
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-12">
        ...
        <div
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8">
            <StatCounter end={12} suffix="+" label="Projects shipped" />
            <StatCounter end={3} suffix="+" label="Years crafting" />
        ...
        <div
          ...
          <div className="flex items-center gap-3 text-white/15 text-xs flex-wrap justify-center md:justify-start">
            <span>© 2026</span>
            <span style={{ color: "rgba(255,255,255,0.06)" }}>·</span>
            <span className="font-comforter italic text-white/20">
              made with 🔥 not templates
            </span>
          </div>
